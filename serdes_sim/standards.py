...
def measurement_contracts(cfg, active_profile=None, active_meta=None):
    ...
    return [
        row("com", "COM", "IEEE 802.3ck", "Annex 93A · 100GBASE-KR1",
            ...
            IEEE_COM),
        row("tdecq", "TDECQ", "IEEE 802.3bs", "124.8.5 · metodo 121.8.5",
            "optical PMD measurement point after the reference receiver",
            optical_pam4, "versioned-procedure", "not-assessed",
            "LabPro DR4 v1 runs the full public SSPRQ period at both Table 124-11 dispersion endpoints through BT4, a normalized 5-tap reference FFE, and the complete RX/DSP path. Optical reflection/polarization stress, traceable instrument uncertainty, and golden-instrument correlation remain explicit blockers."),
