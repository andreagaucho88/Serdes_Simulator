...
TOPICS = [
    ...
    _topic(
        ...
        "Metti rx_ppm_offset −200: la traccia di frequenza converge a −200 ppm (il loop assorbe l'offset fisico f_RX−f_TX). Poi misura la OJTF e trova il −3 dB.",
        "Set rx_ppm_offset −200: the frequency trace converges to −200 ppm (the loop absorbs the physical f_RX−f_TX offset). Then measure the OJTF and find the −3 dB point.",
